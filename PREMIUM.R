...
#I'm not sure if the problem is the dataset that I'm using are my models, the historical dataset that you sent to me for the assignment was very smooth and didn't have any inconsistencies.
# If you get time, May you please simulate some variables for me on that one such as the car_value and maybe the past_claim_cost and other variables if necessary. i want to see if i can actually calculate the premium.
# It should take me a less that a day to finish that project upon receiving the simulated dataset.
